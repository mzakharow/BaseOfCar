...
<title>Base Of Car Signup</title>
...
<body>
	...
	<div class="container">
		<div class="jumbotron">
			<div>
				<h1>Welcome to Base of car Signup</h1>
				...
				<div class="row">
					<div class="col-lg-6">
						<form:form id="myForm" method="post"
							class="bs-example form-horizontal" commandName="car">
							<fieldset>
								<legend>Base of car Signup Form</legend>
